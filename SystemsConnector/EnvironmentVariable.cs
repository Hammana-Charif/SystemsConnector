...
namespace SystemsConnector
{
    ...
    {
        private const string SIRENE_API_KEY = ""; //constante pour le token Sirene.fr
        private const string STOCKMANAGER_API_BASE_URL = ""; // constante pour la base url pour le système StockManager
